...
public final class TasksSummaryServletTest extends AuthenticatedServletTestBase {
  private AuthenticationVerifier authenticationVerifier;
  private TasksClientFactory tasksClientFactory;
  private TasksClient tasksClient;
  private TasksSummaryServlet servlet;
  ...
  public void setUp() throws Exception {
    ...
    servlet = new TasksSummaryServlet(authenticationVerifier, tasksClientFactory);
